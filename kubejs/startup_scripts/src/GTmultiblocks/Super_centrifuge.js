...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('super_centrifuge', 'multiblock')
        ...
        .recipeType(['centriuge','differential_centrifuge'])
        ...
        .workableCasingRenderer('gtceu:block/casing/stable_machine_casing', 'gtceu:block/multiblock/implosion_compressor', false)
})