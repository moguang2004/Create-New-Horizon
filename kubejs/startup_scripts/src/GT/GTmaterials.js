GTCEuStartupEvents.registry("gtceu:element", event => {
    event.create("mana", 169, 169, -1, null, "Ma", false)
    event.create("mana_mixed_1", 169, 169, -1, null, "????Ma????", false)
    event.create("mana_mixed_2", 169, 169, -1, null, "???Ma???", false)
    event.create("mana_lp_mixed", 169, 169, -1, null, "??Ma??LP+", false)
    event.create("mana_demon_mixed", 169, 169, -1, null, "?Ma?LP++", false)
    event.create("mana_plus2", 300, 300, -1, null, "Ma+", false)
    event.create('mana_plus3', 300, 300, -1, null, "Ma++++", false)
})
...
GTCEuStartupEvents.registry("gtceu:material", event => {
    ...
    event.create('kevlar_stone_growth_liquid')
        .liquid()
        .color(0xAAAAAA)
    event.create("mana_fused_mixed1")
        .dust()
        .element(GTElements.get('mana_mixed_2'))
        .color(0x4FC1FF)
    event.create("mana_fused_mixed_lp")
        .dust()
        .element(GTElements.get('mana_lp_mixed'))
        .color(0x0000A0)
    event.create("mana_fused_mixed_demon")
        .dust()
        .element(GTElements.get('mana_demon_mixed'))
        .color(0x0000A0)
    event.create("mana_plus2")
        .dust()
        .ingot()
        .color(0x0a59a3)
        .element(GTElements.get('mana_plus2'))
        .liquid()
        .flags(GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_BOLT_SCREW, GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_FRAME, GTMaterialFlags.GENERATE_RING)
