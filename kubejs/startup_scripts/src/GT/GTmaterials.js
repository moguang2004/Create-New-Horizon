...
GTCEuStartupEvents.registry("gtceu:material", event => {
    ...
    event.create('arsenic_trioxide')
        .dust()
        .ore()
        .addOreByproducts(GTMaterials.get('nickeline'),GTMaterials.Realgar)
        .components('2x arsenic','3x oxygen')
...
StartupEvents.postInit(event => {
    ...
    GTMaterials.get("ammonium_hydroxide").setFormula("NH4OH")
    GTMaterials.get("niobium_tantalite").setFormula("Ta-Nb")
    GTMaterials.get("ammonium_fluoride").setFormula("NH4F")
    GTMaterials.get("rare_earth_fe_one").setFormula("Fe4?")
    GTMaterials.get("rare_earth_fe_two").setFormula("Fe2?")
    GTMaterials.get("rare_earth_intensive_research").setFormula("???")
    GTMaterials.get("rare_earth_crystals").setFormula("??")
