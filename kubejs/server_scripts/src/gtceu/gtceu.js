...
ServerEvents.recipes(event =>{
    ...
    .duration(100)
    .EUt(32)
    event.recipes.gtceu.alloy_smelter('andesitealloy')
    .EUt(7)
    .duration(100)
    .itemInputs('minecraft:andesite')
    .itemInputs('minecraft:iron_ingot')
    .itemOutputs('2x gtceu:andesitealloy_ingot')
    ...
    .EUt(-32)
    .duration(20)
    event.recipes.gtceu.hot_coolant_turbine('sodium_potassium_alloy')
    .inputFluids(Fluid.of('gtceu:hot_sodium_potassium_alloy',90))
    .outputFluids(Fluid.of('gtceu:sodium_potassium_alloy',90))
    .EUt(-32)
    .duration(20)
})