...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.martial_morality_eye("ore_production_1")
        ...
        .chancedOutput('64x gtceu:raw_trona', 2000, 0)
        .chancedOutput('64x gtceu:raw_asbestos', 2000, 0)
        .chancedOutput('64x gtceu:raw_vanadium', 2000, 0)
        .chancedOutput('64x gtceu:raw_tin', 2000, 0)
        .chancedOutput('64x gtceu:raw_nickel', 2000, 0)
        .chancedOutput('64x gtceu:raw_silver', 2000, 0)
        .chancedOutput('64x minecraft:raw_gold', 2000, 0)
        .chancedOutput('64x gtceu:raw_antimony', 2000, 0)
        .chancedOutput('64x minecraft:raw_copper', 2000, 0)
        .chancedOutput('64x minecraft:raw_iron', 2000, 0)
        .chancedOutput('64x gtceu:raw_cassiterite', 2000, 0)
        .chancedOutput('64x gtceu:raw_cassiterite_sand', 2000, 0)
        .chancedOutput('64x gtceu:raw_chalcopyrite', 2000, 0)
        .chancedOutput('64x gtceu:raw_cinnabar', 2000, 0)
        .chancedOutput('64x gtceu:raw_coal', 2000, 0)
        .chancedOutput('64x gtceu:raw_diamond', 2000, 0)
        .chancedOutput('64x gtceu:raw_garnierite', 2000, 0)
        .chancedOutput('64x tetra:geode', 2000, 0)
        .chancedOutput('64x gtceu:raw_calcite', 2000, 0)
        .chancedOutput('64x gtceu:raw_vanadium_magnetite', 2500, 0)
        .chancedOutput('64x gtceu:raw_tantalite', 2000, 0)
        .chancedOutput('64x gtceu:raw_apatite', 2000, 0)
        .chancedOutput('64x gtceu:raw_lapis', 2000, 0)
    ...
    event.recipes.gtceu.martial_morality_eye("ore_production_2")
        ...
        .chancedInput('64x minecraft:diamond_block', 750, -100)
