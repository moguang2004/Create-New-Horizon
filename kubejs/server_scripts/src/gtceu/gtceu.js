...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.phase_inversion("QBIT_CPU_reverse")
        ...
        .duration(5000)
        .EUt(480)
    event.recipes.gtceu.phase_inversion("elementium_cpu")
        .itemInputs('kubejs:mana_cpu_wafer')
        .itemInputs('kubejs:elementium_cpu_chip')
        .inputFluids(Fluid.of("gtceu:zenith_essence", 120))
        .itemOutputs('kubejs:elementium_cpu_wafer')
        .duration(5000)
        .EUt(480)
    event.recipes.gtceu.phase_inversion("mana_cpu")
        .itemInputs('kubejs:mana_cpu_chip')
        .inputFluids(Fluid.of("gtceu:zenith_essence", 60))
    ...
    event.recipes.gtceu.compressor("wood_particle_collider")
        ...
        .duration(1200)
        .EUt(7)
    event.recipes.gtceu.wood_particle_collider("snow_steel_ingot_process")
        .itemInputs('64x ctnhcore:animal_excreta')
        .itemOutputs('gtceu:snow_steel_ingot')
        .duration(20)
        .inputStress(1048576)
    ...
    event.recipes.gtceu.assembly_line('void_miner_create')
        ...
        .stationResearch(b => b.researchStack(Item.of('gtceu:luv_large_miner'))
            ...
            .EUt(GTValues.VA[GTValues.ZPM])
            .CWUt(32))
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_1")
        .itemInputs('32x gtceu:hematite_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_2")
        .itemInputs('32x gtceu:iron_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_3")
        .itemInputs('32x gtceu:goethite_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_4")
        .itemInputs('32x gtceu:magnetite_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_5")
        .itemInputs('32x gtceu:pyrite_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
    event.recipes.gtceu.sintering_kiln("refined_iron_ingot_6")
        .itemInputs('32x gtceu:yellow_limonite_dust', '16x gtceu:coke_dust')
        .itemOutputs('6x ctnhcore:refined_iron_ingot')
        .inputStress(8192)
        .duration(200)
