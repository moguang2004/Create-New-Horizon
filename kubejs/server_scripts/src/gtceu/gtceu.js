...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.assembler("ctnhcore:bedrock_drilling_rigs")
    ...
    .duration(1200)
    .EUt(122880)
  event.recipes.gtceu.eye_homo("chankuang")
    ...
    .duration(600)
  event.recipes.gtceu.eye_homo("chankuang1")
    ...
    .EUt(96)
    .duration(600);
  event.recipes.gtceu.eye_homo("chankuang2")
    .itemInputs('64x minecraft:stone')
  ...
  event.recipes.gtceu.chemical_reactor("yinxiufu1")
    ...
    .duration(50)
    .EUt(600)
  event.recipes.gtceu.chemical_reactor("yinxiufu2")
    .circuit(4)
    ...
    .duration(200)
    .EUt(600)
  event.recipes.gtceu.electrolyzer("yaliusuanlvxiufu")
    ...
    .duration(280)
    .EUt(60)
  event.recipes.gtceu.gas_collection_h("zhushijieair1")
    .circuit(0)
    .outputFluids("gtceu:air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("zhushijieair2")
    .circuit(1)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("xiajieair1")
    .circuit(2)
    .outputFluids("gtceu:nether_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("xiajieair2")
    .circuit(3)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_nether_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("modiair1")
    .circuit(4)
    .outputFluids("gtceu:ender_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("modiair2")
    .circuit(5)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_ender_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("tianjingair1")
    .circuit(6)
    .outputFluids("gtceu:aether_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("tianjingair2")
    .circuit(7)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_aether_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("manaair1")
    .circuit(8)
    .outputFluids("gtceu:alfheim_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("manaair2")
    .circuit(9)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_alfheim_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("museair1")
    .circuit(10)
    .outputFluids("gtceu:twilightforest_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("museair2")
    .circuit(11)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_twilightforest_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("goldair1")
    .circuit(12)
    .outputFluids("gtceu:venus_air 1000000")
    .EUt(480)
    .duration(200)
  event.recipes.gtceu.gas_collection_h("goldair2")
    .circuit(13)
    .itemInputs('gtceu:vacuum_freezer')
    .outputFluids("gtceu:liquid_venus_air 1000000")
    .EUt(1920)
    .duration(200)
  event.recipes.gtceu.assembly_line('yasuo1')
    ...
    .stationResearch(b => b.researchStack(Item.of('gtceu:luv_fusion_reactor'))
      ...
      .EUt(GTValues.VA[GTValues.LuV])
      .CWUt(16))
  event.recipes.gtceu.assembly_line('yasuo2')
    ...
    .stationResearch(b => b.researchStack(Item.of('gtceu:zpm_fusion_reactor'))
      ...
      .EUt(GTValues.VA[GTValues.ZPM])
      .CWUt(32))
  event.recipes.gtceu.assembly_line('yasuo3')
    ...
    .stationResearch(b => b.researchStack(Item.of('gtceu:uv_fusion_reactor'))
      ...
      .EUt(GTValues.VA[GTValues.UV])
      .CWUt(64))
  event.recipes.gtceu.assembler("naihuozhuan1")
  ...
  event.recipes.gtceu.assembly_line('decay_pools_machine')
    ...
    .stationResearch(b => b.researchStack(Item.of('gtceu:large_fermenting_tank'))
      ...
      .EUt(GTValues.VA[GTValues.UV])
      .CWUt(64))
  event.recipes.gtceu.assembly_line('caihongrolu')
    ...
    .stationResearch(b => b.researchStack(Item.of('ironfurnaces:netherite_furnace'))
      ...
      .EUt(GTValues.VA[GTValues.ZPM])
      .CWUt(64))
  event.recipes.gtceu.assembler("denglizilengningxianquan")
    ...
    .EUt(24768)
    .duration(200)
  event.recipes.gtceu.assembler("denglizijixiewaike")
    ...
    .EUt(24768)
    .duration(50)
  event.recipes.gtceu.assembly_line('denglizilengnqi')
  ...
  event.recipes.gtceu.chemical_reactor('gtceu:sodium_carbonate_solution1')
    ...
    .EUt(16)
    .duration(50)
  event.recipes.gtceu.mixer('shanditi')
    ...
    .EUt(122320)
    .duration(200)
  event.recipes.gtceu.polarizer('shanditi1')
    ...
    .EUt(490120)
    .duration(100)
  event.recipes.gtceu.polarizer('shanditi2')
    ...
    .EUt(490120)
    .duration(100)
  event.recipes.gtceu.polarizer('shanditi3')
    ...
    .EUt(490120)
    .duration(200)
  event.recipes.gtceu.assembler('jigaoyaxianquan')
