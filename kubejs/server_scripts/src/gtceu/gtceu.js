...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('ctnhcore:atoms_split_blocks')
        .itemInputs('gtceu:uhv_field_generator', 'gtceu:uhv_field_generator', 'gtceu:uhv_field_generator', 'gtceu:uhv_field_generator', 'ctnhcore:reactor_condensation_block', 'ctnhcore:annihilate_core_mki', 'ctnhcore:depth_force_field_stabilizing_casing')
