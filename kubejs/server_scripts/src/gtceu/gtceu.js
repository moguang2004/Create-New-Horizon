...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.circuit_assembly('circuit_resonatic_ulv')
    .itemInputs(['gtceu:magneto_resonatic','imprinted_resonatic_circuit_board','gtceu:vaccum_tube','4x gtceu:diode','4x gtceu:capacitor','4x gtceu:transistor'])
    .inputFluids(Fluid.of('gtceu:soldering_alloy',36))
    .itemOutputs('4x gtceu:circuit_resonatic_ulv')
    .EUt(30)
    .duration(75)
  event.recipes.gtceu.circuit_assembly('circuit_resonatic_lv')
    .itemInputs(['gtceu:magneto_resonatic','imprinted_resonatic_circuit_board','gtceu:circuit_resonatic_lv','4x gtceu:diode','4x gtceu:capacitor','4x gtceu:transistor'])
