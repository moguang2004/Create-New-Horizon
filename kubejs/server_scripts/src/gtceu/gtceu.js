...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler("twist_frame")
        .itemInputs(['1x gtceu:ultra_mana_plate', '3x gtceu:mana_super_plus_plate', '2x gtceu:double_rhodium_plated_palladium_plate', 'gtceu:osmiridium_frame', 'bloodmagic:defaultcrystal', 'gtceu:fusion_casing'])
    ...
    event.recipes.gtceu.assembly_line('advance_machine_casing_assembly_control')
        .itemInputs('gtceu:special_composite_steel_m77_frame', '8x gtceu:uhpic_chip', '8x #gtceu:circuits/uv', '4x gtceu:zpm_electric_motor', '4x gtceu:zpm_emitter', '4x gtceu:zpm_sensor')
        .inputFluids('gtceu:cerrobase_140 16000')
    ...
    event.recipes.gtceu.assembly_line('advance_machine_casing_assembly_line')
        .itemInputs('gtceu:special_composite_steel_m77_frame', '8x gtceu:special_composite_steel_m77_plate', '16x gtceu:small_inconel_625_gear', '16x gtceu:small_hsss_gear', '16x gtceu:small_hssg_gear', '16x gtceu:small_eglin_alloy_gear', '4x gtceu:luv_robot_arm')
        .inputFluids('gtceu:cerrobase_140 16000')
    ...
    event.recipes.gtceu.assembly_line('advance_assembly_line')
        .itemInputs('gtceu:zpm_machine_hull', '4x ctnhcore:advance_machine_casing_assembly_control', '4x ctnhcore:advance_machine_casing_assembly_line', '12x #gtceu:circuits/zpm', '16x gtceu:zpm_robot_arm', '16x gtceu:zpm_robot_arm', '16x gtceu:zpm_robot_arm', '16x gtceu:zpm_robot_arm')
        .inputFluids('gtceu:cerrobase_140 16000')
    ...
    event.recipes.gtceu.chemical_reactor('wolframite')
        ...
        .duration(30)
        .EUt(24)
    event.recipes.gtceu.chemical_reactor('tarkianite_acid_leaching')
    ...
    event.recipes.gtceu.electrolyzer('osmium_iron_spinel_dust')
        ...
        .duration(200)
        .EUt(1920)
    event.recipes.gtceu.mixer("neutronium_mixture_dust")
        .itemInputs('4x gtceu:neutronium_mixture_dust')
        .inputFluids('gtceu:neutronium 288')
        .itemOutputs('3x gtceu:neutronium_dust')
        .EUt(122330)
        .duration(200)
    event.recipes.gtceu.assembler("t2_plate")
        .itemInputs('gtnn:heavy_plate_t1', '2x gtceu:dense_desh_plate', '2x gtceu:dense_vanadium_steel_plate')
        .inputFluids("gtceu:tungsten_steel 144")
        .itemOutputs('gtnn:heavy_ingot_t2')
        .EUt(1920)
        .duration(300)
    event.recipes.gtceu.assembler("t3_plate")
        .itemInputs('gtnn:heavy_plate_t2', '4x gtceu:dense_ostrum_plate', '4x gtceu:dense_iridium_plate')
        .inputFluids("gtceu:platinum 432")
        .itemOutputs('gtnn:heavy_ingot_t3')
        .EUt(30720)
        .duration(300)
    event.recipes.gtceu.assembly_line("t4_plate")
        .itemInputs('gtceu:neutron_reflector', 'gtnn:heavy_plate_t1', 'gtnn:heavy_plate_t2', 'gtnn:heavy_plate_t3', '7x gtceu:dense_calorite_plate', '7x gtceu:dense_calorite_plate', '7x gtceu:dense_rhodium_plated_palladium_plate', '7x gtceu:dense_rhodium_plated_palladium_plate')
        .inputFluids("gtceu:cerrobase_140 288")
        .inputFluids("gtceu:hssg 288")
        .itemOutputs('3x gtnn:heavy_ingot_t4')
        .duration(400)
        .EUt(122330)
        .stationResearch(b => b.researchStack(Item.of('gtnn:heavy_plate_t3'))
            .dataStack(Item.of("gtceu:data_orb"))
            .EUt(GTValues.VA[GTValues.LuV])
            .CWUt(16))
})