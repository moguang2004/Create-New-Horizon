...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.fake_meteor("platinum")
    .itemInputs('gtceu:hv_emitter')
    .chancedOutput('gtceu:moon_stone_ilmenite_ore',1613,0)
    .chancedOutput('gtceu:moon_stone_aluminium_ore',1935,0)
    .chancedOutput('gtceu:moon_stone_bauxite_ore',2580,0)
    .chancedOutput('gtceu:moon_stone_cooperite_ore',1290,0)
    .chancedOutput('gtceu:moon_stone_tetrahedrite_ore',2580,0)
