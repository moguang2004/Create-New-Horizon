...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.void_miner_processing('void_miner_1')
    .circuit(1)
    .chancedOutput('64x gtceu:raw_uranium', 2500, 0)
    .chancedOutput('64x gtceu:raw_uranium_235', 2500, 0)
    .chancedOutput('64x gtceu:raw_vanadium', 2500, 0)
    .chancedOutput('64x gtceu:raw_zinc', 2500, 0)
    .chancedOutput('64x gtceu:raw_naquadah', 2500, 0)
    .chancedOutput('64x gtceu:raw_enriched_naquadah', 2500, 0)
    .chancedOutput('64x gtceu:raw_naquadria', 2500, 0)
    .chancedOutput('64x gtceu:raw_coal', 2500, 0)
    .chancedOutput('64x gtceu:raw_diamond', 2500, 0)
    .chancedOutput('64x gtceu:raw_platinum', 2500, 0)
    .chancedOutput('64x gtceu:raw_plutonium', 2500, 0)
    .chancedOutput('64x gtceu:raw_plutonium_241', 2500, 0)
    .chancedOutput('64x gtceu:raw_silver', 2500, 0)
    .chancedOutput('64x gtceu:raw_sulfur', 2500, 0)
    .chancedOutput('64x gtceu:raw_thorium', 2500, 0)
    .chancedOutput('64x gtceu:raw_tin', 2500, 0)
    .chancedOutput('64x gtceu:raw_titanium', 2500, 0)
    .chancedOutput('64x gtceu:raw_tungsten', 2500, 0)
    .chancedOutput('64x gtceu:raw_lead', 2500, 0)
    .chancedOutput('64x gtceu:raw_lithium', 2500, 0)
    .chancedOutput('64x gtceu:raw_manganese', 2500, 0)
    .chancedOutput('64x gtceu:raw_molybdenum', 2500, 0)
    .chancedOutput('64x gtceu:raw_neodymium', 2500, 0)
    .chancedOutput('64x gtceu:raw_nickel', 2500, 0)
    .chancedOutput('64x gtceu:raw_niobium', 2500, 0)
    .chancedOutput('64x gtceu:raw_osmium', 2500, 0)
    .chancedOutput('64x gtceu:raw_palladium', 2500, 0)
    .chancedOutput('64x gtceu:raw_aluminium', 2500, 0)
    .chancedOutput('64x gtceu:raw_antimony', 2500, 0)
    .chancedOutput('64x gtceu:raw_arsenic', 2500, 0)
    .chancedOutput('64x gtceu:raw_beryllium', 2500, 0)
    .chancedOutput('64x gtceu:raw_bismuth', 2500, 0)
    .chancedOutput('64x gtceu:raw_chromium', 2500, 0)
    .chancedOutput('64x gtceu:raw_cobalt', 2500, 0)
    .chancedOutput('64x gtceu:raw_gallium', 2500, 0)
    .chancedOutput('64x gtceu:raw_iridium', 2500, 0)
    .EUt(1966080)
    .duration(4000)
