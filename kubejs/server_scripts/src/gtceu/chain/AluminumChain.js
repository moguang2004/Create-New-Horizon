ServerEvents.recipes(event =>{
    ...
    //所有副产为铝粉的配方改为副产氧化铝粉
    event.replaceOutput({output:'gtceu:aluminium_dust',type:'gtceu:centrifuge',not:{or:[
        ...
        {id:'gtceu:centrifuge/decomposition_centrifuging__maraging_steel_300'}]}},'gtceu:aluminium_dust','gtceu:alumina_dust')
    
    event.replaceOutput({output:'gtceu:aluminium_dust',type:'gtceu:ore_washer',not:{or:[
    ...
    event.replaceOutput({output:'gtceu:aluminium_dust',type:'gtceu:macerator',or:[
