ServerEvents.recipes(event => {
    ...
    ctnh.fuel_refining_mk1("diesel")
        ...
        .EUt(1920)
        .duration(500).blastFurnaceTemp(2273)
    //生物柴油
    ctnh.fuel_refining_mk1("bio_diesel1")
        ...
        .EUt(1920)
        .duration(600).blastFurnaceTemp(2273)
    ...
    ctnh.fuel_refining_mk1("gasoline")
        ...
        .EUt(1920)
        .duration(480).blastFurnaceTemp(3200)
    //高辛烷值柴油
    ctnh.fuel_refining_mk1("high_octane_gasoline")
        ...
        .EUt(1920)
        .duration(960).blastFurnaceTemp(5200)
    //高十六烷值柴油
    ctnh.fuel_refining_mk1("cetane_boosted_diesel1")
        ...
        .EUt(1920)
        .duration(560).blastFurnaceTemp(4200)
