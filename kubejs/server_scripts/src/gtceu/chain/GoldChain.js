ServerEvents.recipes(event =>{
    ...
    event.replaceOutput({id:'gtceu:centrifuge/centrifuge_magnetite_pure_dust_to_dust'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:centrifuge/centrifuge_copper_pure_dust_to_dust'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:centrifuge/netherrack_separation'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:thermal_centrifuge/centrifuge_magnetite_purified_ore_to_refined_ore'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:thermal_centrifuge/centrifuge_magnetite_crushed_ore_to_refined_ore'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:thermal_centrifuge/centrifuge_copper_purified_ore_to_refined_ore'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    event.replaceOutput({id:'gtceu:thermal_centrifuge/centrifuge_copper_crushed_ore_to_refined_ore'},'gtceu:gold_tiny_dust','gtceu:precious_alloy_tiny_dust')
    ...
    event.replaceOutput({id:'gtceu:electromagnetic_separator/separate_vanadium_magnetite_pure_dust_to_dust'},'gtceu:gold_small_dust','gtceu:precious_alloy_small_dust')
    event.replaceOutput({id:'gtceu:electromagnetic_separator/separate_magnetite_pure_dust_to_dust'},'gtceu:gold_small_dust','gtceu:precious_alloy_small_dust')
    event.replaceOutput({id:'gtceu:electromagnetic_separator/separate_granitic_mineral_sand_pure_dust_to_dust'},'gtceu:gold_small_dust','gtceu:precious_alloy_small_dust')
    event.replaceOutput({id:'gtceu:electromagnetic_separator/separate_basaltic_mineral_sand_pure_dust_to_dust'},'gtceu:gold_small_dust','gtceu:precious_alloy_small_dust')
})
ServerEvents.recipes(event =>{
    event.recipes.gtceu.centrifuge('tier1_gold_processing')
    .itemInputs('4x gtceu:gold_alloy_dust')
    .itemOutputs('4x gtceu:gold_tiny_dust','3x gtceu:copper_dust')
    .duration(500)
    .EUt(30)
    ...
    .itemInputs('4x gtceu:gold_leach_dust')
                ...
                .itemOutputs('8x gtceu:gold_tiny_dust')
                .duration(300)
                .EUt(30)
