ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.mana_reactor('kubejs:zenith_star')
        ...
        .itemInputs('gtceu:ultra_mana_ingot')
    ...
    event.recipes.gtceu.mark_of_falling_tower('star')
        ...
        .chancedOutput('4x botania:rune_mana', 6000, 2000)
    ...
    event.recipes.gtceu.mana_reactor("elf_fuel_2")
        .chancedInput('botania:entropinnyum', 2000, -1000)
    ...
    event.recipes.gtceu.mana_reactor('gtceu:blood_fuel_active_recycle')
        .inputFluids(Fluid.of('gtceu:blood_fuel_exhuasted', 6666))
        .itemInputs('4x bloodmagic:defaultcrystal')
        .chancedInput('kubejs:endslate', 9000, -900)
        .EUt(6666)
        .duration(200)
        .outputFluids(Fluid.of('gtceu:blood_fuel_active', 6666))
    ...
    event.recipes.gtceu.quasar_eye("elf_fuel_4")
        ...
        .outputFluids(Fluid.of('gtceu:starlight_fuel_exhausted', 1000))
        .addData("consumption", 1000000)
        .addData("tier", 3)
        .addData("active", 2)
        .EUt(-201326592)
    ...
    event.recipes.gtceu.quasar_eye("blood_fuel_active")
        .inputFluids(Fluid.of('gtceu:blood_fuel_active', 12000))
        .outputFluids(Fluid.of('gtceu:blood_fuel_active', 9000))
        .addData("consumption", 10000)
        .addData("tier", 2)
        .addData("active", 2)
        .EUt(-67108864)
    ...
    event.recipes.gtceu.quasar_eye('gtceu:mana_up_fuel_active')
        ...
        .EUt(-268435456)
        .duration(400)
    event.recipes.gtceu.mana_reactor('blood_fuel')
        .inputFluids(Fluid.of('gtceu:elf_fuel', 2880))
        .itemInputs('bloodmagic:etherealslate')
        .inputFluids(Fluid.of('bloodmagic:life_essence_fluid', 144000))
        .outputFluids(Fluid.of('gtceu:blood_fuel', 6666))
        .EUt(6666)
        .duration(400)
