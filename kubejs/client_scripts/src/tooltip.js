...
ItemEvents.tooltip(event =>{
    ...
    event.add('kubejs:mana_electronic_circuit',Text.translate('ctnh.circuit_mana_hv'))
    event.add('kubejs:echo_processor',Text.translate('ctnh.circuit_echo_zpm'))
    event.add('kubejs:echo_processor_assembly',Text.translate('ctnh.circuit_echo_uv'))
    event.add('kubejs:echo_processor_computer',Text.translate('ctnh.circuit_echo_uhv'))
    event.add('kubejs:echo_processor_mainframe',Text.translate('ctnh.circuit_echo_uev'))
})